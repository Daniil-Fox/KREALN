...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_gsap_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/gsap.js */ "./src/js/components/gsap.js");
...
gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(swipePanels, {
  zIndex: i => i
});

// create an observer and disable it to start
let intentObserver = gsap_ScrollTrigger_js__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger.observe({
  type: "wheel,touch",
  onUp: () => {
  ...
  onPress: self => {
    ...
    gsap_ScrollTrigger_js__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger.isTouch && self.event.preventDefault();
  }
});
