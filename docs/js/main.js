...
function initOrbit() {
  ...
  const tl2 = gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.timeline();
  function incr() {
  ...
  function incrSlides() {
    ...
    gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.to('.orbit', {
  ...
  function decrSlides() {
    ...
    tl2.to(orbitNext[next + 1], {
      zIndex: -1,
      opacity: 0
    });
    tl2.to(orbitNext[(currentIndex + 1) % orbitActive.length], {
      zIndex: 2,
      opacity: 1
    });
  }
